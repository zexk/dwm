...
static const char *fonts[]          = { "PixelCode:antialiasing=false:size=18" };
static const char dmenufont[]       = "PixelCode:antialiasing=false:size=18";
...
/* layout(s) */
static const float mfact     = 0.20; /* factor of master area size [0.05..0.95] */
